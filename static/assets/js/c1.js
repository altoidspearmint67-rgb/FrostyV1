// cloak.js
let appInd;
const g = window.location.pathname.includes("games");
const a = window.location.pathname.includes("apps");
const c = window.location.pathname.includes("tabs");
